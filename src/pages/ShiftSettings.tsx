...
import { AlertCircle, Pencil, Plus, Trash2, Clock } from "lucide-react";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Configure shift times per campaign. Edit these whenever DST changes or
          schedules shift. The timeclock uses these times to calculate lateness
          and auto-clockout.
        </p>
      </div>
                    ...
                    {list.map((s) => (
                      ...
                      >
                        <div className="flex-1">
                          <div className="font-semibold">{s.shift_name}</div>
                        ...
                        <div className="flex gap-1">
                          ...
                          <Button
                            ...
                            variant="ghost"
                            onClick={() => {
                              if (confirm(`Delete "${s.shift_name}"?`)) {
      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-2">
          <div>
            ...
            <Input
              id="shift-name"
              placeholder="e.g. Standard, Summer, Weekend"
              value={name}
